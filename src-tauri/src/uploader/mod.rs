...
fn resolve_base_urls(_base_url: Option<String>) -> Vec<String> {
    ...
    // Use only the production API endpoint from build-time env or fallback.
    let api_url = option_env!("UPLOAD_API_URL")
        .unwrap_or("https://placeholder-upload-url.com/api/v1"); // Fallback for dev/legacy
...
mod tests {
    ...
    fn test_fallback_url_ordering_when_no_base_url() {
        ...
        assert_eq!(base_urls[0], "https://placeholder-upload-url.com/api/v1");
    }
    ...
    fn test_url_formatting() {
        ...
        let base_urls = vec![
            ...
            "https://placeholder-upload-url.com/api/v1".to_string(),
            "https://custom.example.com/api/".to_string(),
        ];

        let expected_endpoints = vec![
            "http://localhost:8080/api/v1/upload/",
            "https://placeholder-upload-url.com/api/v1/upload/",
